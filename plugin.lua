...
`با استفاده از این کلید میتوانید نام کانال، یوزرنیم کانال، آی دی کانال، شماره ارتباطی با سامانه پیامکی، انقضای اکانت، آمار کانال، سازنده ی کانال، تعداد ادمینهای کانال، لیست ادمینهای کانال را در یک لیست ببینید.`]]
	...
	elseif msg.text == "مثال کیبرد اینلاین و مارک داون" then
		inlinekey = {{{text = "کانال تیم" , url = "https://telegram.me/senator_tea"}},{{text = "سازنده" , url = "https://telegram.me/dr_slow_sudo"}}}
		text = "مثال استایل نویس با فونتهای مختلف:\n*senator Team*\nsenator Team\n_Csgroup Team_\n`senator Team`\nتیم سسناتور گروپ\n`تیم سناتور گروپ`\nمثال هایپر لینک:\n[تیم سناتور گروپ](telegram.me/senator_tea)\n[senator Team](telegram.me/senator_tea)\nمثال کیبرد اینلاین:"
	...
	if msg.text:find('/add') and msg.from.id == sudo_id then
		...
		if usertarget then
			...
			return send_msg(sudo_id, "*/add 12345678,@senator_tea,9121234567*\n`/add [telegram id],[@channel],[number]`", true)
		end
	elseif msg.text:find('/edit') and msg.from.id == sudo_id then
		...
		if usertarget then
			...
			return send_msg(sudo_id, "*/edit 12345678,@senator_tea,9121234567*\n`/edit [telegram id],[@channel],[number]`", true)
		end
	...
	elseif msg.text == "مثال کیبرد اینلاین" then
		return send_inline(msg.from.id, "`تیتر کیبرد اینلاین با قابلیت استفاده از قابلیت مارک داون`", {{{text = "کانال تیم" , url = "https://telegram.me/senator_tea"}}})
	end
